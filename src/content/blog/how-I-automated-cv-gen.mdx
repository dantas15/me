...
seo:
  image: 
    src: '/blog/how-I-automated-cv-gen.png'
...
![A person is handing over a document to another person, who is reaching out to receive it. The image captures the transaction from a close-up perspective, focusing on the hands and the document. The background is bright and softly lit, suggesting a professional or office environment.](/blog/how-I-automated-cv-gen.png)
