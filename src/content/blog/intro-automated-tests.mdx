...
excerpt: What writing tests means and how to enhance your productivity and the assertiveness of your code.
...
![Two women looking at code at the laptop while one of the women is pointing to a specific line of code](/blog/intro-automated-tests.png)
...
But besides the manual labor of manual tests, there's also another problem: How do you keep track of what you have to test, what's already tested and what need testing? Yes, you can write them down, make a checklist or whatever, but again, there's always the manual effort of having to go all the way through your checklist while testing.
...
Automated tests allows you to write code to test the code of your application. There are many ways software can be tested and you'll encounter many names, for example:
...
There are lots of different types of tests and different definitions, but I'll let you dive deeper on yourself as you see fit. It's time to understand a more fundamental approach to writing automated tests.

As a developer you might've already realized that the actual work of a deveoper involves automating repetitive tasks. You can think of automated tasks just as a way to automate all the repetitive and manual tests you do when you test it manually.

That means that based on a *specific environment* of your software, you *take action* just like the user would've and you *verify* that the code works as it's supposed to.
...
Well... Automated tests are... automated?

Just kidding. But yeah, that's true, you no longer have to debug your code and provide all the inputs and all the configuration every time you have to test it.
...
Of course, there'll be times when you just need to ship faster and writing tests for you `sum(a, b)` function is definitely not worth it. But let this talk of "To Test or Not To Test" for some other time (maybe a future blog post?).
